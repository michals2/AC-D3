...
describe("Bubble Chart Tests", function() {
  ...
  describe("the bubble chart", function() {
    ...
    it("should have the correct height", function() {
      expect(
        document.querySelector(".bubble-chart").getAttribute("height")
      ).toBe("600");
    });

    it("should have the correct width", function() {
      expect(
        document.querySelector(".bubble-chart").getAttribute("width")
      ).toBe("600");
    });

    it("should have the correct number of bubbles", function() {
      expect(document.querySelector(".bubble-chart").childElementCount).toBe(
        data1.length
      );
    });
  });
